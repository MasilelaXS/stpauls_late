<?php
/*
Get late records statistics by grade
GET /api/reports/late_by_grade.php?year_id=1&start_date=2024-01-01&end_date=2024-01-31
Return grade-wise late statistics
...
try {
    ...
    $query .= " GROUP BY l.grade ORDER BY l.grade ASC";
    ...
    error_log("Late by grade error: " . $e->getMessage());
